          ...
          <div className={styles.reconheDiv}>
            <div className={styles.reconheDivLojas}>
              <div className={styles.reconheFlex}>
                ...
                <div className={styles.reconheFlex1}>
                    <p><a href='https://www.lojascem.com.br/site/' target='_blank'><img src='www.png' width='10%' alt='Icone do Site'/></a>
                    </p>
                </div>
                <div className={styles.reconheFlex1}>
                      <p><a href='https://www.facebook.com/lojascem' target='_blank'><img src='logo_facebook.png' width='10%' alt='Icone do Facebook'/></a>
                    </p>
                </div>
              </div>
            </div>
